    ...
    return useMemo(() => ({
        ...
        input: {
            ...
            simulateMouseMove: (x: number, y: number) =>
                window.mulby?.input?.simulateMouseMove(x, y),
            simulateMouseClick: (x: number, y: number) =>
                window.mulby?.input?.simulateMouseClick(x, y),
            simulateMouseDoubleClick: (x: number, y: number) =>
                window.mulby?.input?.simulateMouseDoubleClick(x, y),
            simulateMouseRightClick: (x: number, y: number) =>
                window.mulby?.input?.simulateMouseRightClick(x, y),
        },
